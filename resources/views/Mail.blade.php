<div style="margin:auto;background-color: rgb(245,245,241);height:700px;overflow: hidden;">
    ...
    <div style="position: absolute;height: 60px;width: 100%;bottom: 0;background-color: rgb(217,217,217);text-align: center;line-height: 60px;">
        <div style="color: #777;">
            © 2018 AdsionLi. Welcome to exchange.
        </div>
    </div>
</div>
